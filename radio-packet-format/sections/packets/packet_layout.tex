...
\begin{figure}[H]
    ...
    \begin{bytefield}[bitwidth=0.03\linewidth]{32}
        ...
        \bitbox[lrb]{8}{} & \bitbox{24}{Packet Number} \\
        \bitbox{16}{Length} & \bitbox{8}{Version} & \bitbox{8}{Src. Addr.} \\
    \end{bytefield}
...
\paragraph{Length}
The \emph{length} field indicates the total length of the packet in bytes. This includes the packet header itself.
...
packet lengths of 4 to 1024 bytes in multiples of four (though a valid packet must have a length of at least 16 bytes).
